...
class SimpleServer extends Thread {
    ...
    private void handleRequest(Socket client) {
        ...
        try {
            ...
            System.out.println(String.format("Server got string 1: %s", command));
            System.out.println(String.format("Server got string 2: %s", userName));
//            Thread.sleep(2000);
